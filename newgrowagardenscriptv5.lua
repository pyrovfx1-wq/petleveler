...
-- 📌 SCRIPT 2: Pet Leveler UI (Loads After Okay)
local function loadPetLevelerUI()
    local pets = {
    ...
    petGui.Name = "PetLevelerUI"
    petGui.ResetOnSpawn = false

    local mainFrame = Instance.new("Frame", petGui)
...
-- 📌 Okay Button Logic (Switches UIs)
okayBtn.MouseButton1Click:Connect(function()
    screenGui:Destroy()  -- Remove Warning
    loadPetLevelerUI()   -- Load Pet UI
end)
